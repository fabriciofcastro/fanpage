...
var Header = function () {
    ...
    return (React.createElement("header", { className: "" + header_module_css_1["default"].header },
        ...
        React.createElement("div", { className: header_module_css_1["default"].icontheme },
            React.createElement(react_2.SunDim, { className: header_module_css_1["default"].iconlight + " " + (isLightDark ? header_module_css_1["default"]['hidden'] : header_module_css_1["default"]['visibility']), onClick: dark }),
            React.createElement(react_2.Moon, { className: header_module_css_1["default"].icondark + "  " + (isLightDark ? header_module_css_1["default"]['visibility'] : header_module_css_1["default"]['hidden']), color: "white", onClick: light })),
