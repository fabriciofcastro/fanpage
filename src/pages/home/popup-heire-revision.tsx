...
export default function DialogHireRevision() {
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <p>
          Prática essencial para garantir a qualidade e a eficiência do software. Promove ciclos contínuos de melhoria e adaptação, beneficiando tanto o desenvolvedor quanto o produto final. Conceito abrangente várias práticas e princípios fundamentais: Interação Contínua, Feedback Constante, Qualidade de Código, Adaptação e Aprendizado e Flexibilidade.
        </p>
